...
%global git_tag 37cb2b3
%global patchnumber 1


Name:		erlang-%{realname}
Version:	0.0.5
Release:	20130121git%{git_tag}%{?dist}
Summary:	gen_server mocking library
Group:		Development/Libraries
License:	Freely redistributable without restriction
URL:		https://github.com/dannaaduna/gen_server_mock
# wget --content-disposition https://github.com/sipxopenacd/gen_server_mock/tarball/37cb2b3
